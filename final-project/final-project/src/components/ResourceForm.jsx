    ...
    <div className="bg-white p-8 rounded-3xl border border-black/5 shadow-sm">
      ...
      <form className="space-y-4">
        ...
        <div className="pt-4 flex gap-4">
          <button type="button" className="flex-1 py-4 bg-brand-rose text-white rounded-2xl font-bold shadow-lg shadow-brand-rose/30 hover:-translate-y-0.5 transition-all">Create</button>
